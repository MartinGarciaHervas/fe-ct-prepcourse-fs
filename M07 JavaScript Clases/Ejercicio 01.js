...
function agregarStringInvertida() {
   ...
   // el .split("") crea un array con cada letra del string ingresado,
   // el .reverse() invierte el orden de los elementos del array creado,
   // el .join("") crea un string a partir del nuevo array, dando como resultado el string original invertido.
}
